...
import org.example.chattingservice.messaging.inbox.repository.InboxRepository;
import org.example.chattingservice.messaging.outbox.entity.OutboxEventFactory;
...
public class UserDeletionEventListener {
    private static final String CONSUMER = "chatting-service";
    ...
    public void onRequested(String payload, Acknowledgment ack) {
        ...
        UserDeletionStepResultEvent resultEvent = UserDeletionStepResultEvent.create(
                ...
                UserDeletionStep.CHAT, status, reason
        );
